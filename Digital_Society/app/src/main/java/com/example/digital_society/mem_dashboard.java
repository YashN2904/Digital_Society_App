...
public class mem_dashboard extends Fragment {
    ...
    private List<Mem_Dash_Model> initdata() {
        ...
        iteamList.add(new Mem_Dash_Model(R.mipmap.complaint,"Complaint"));
        iteamList.add(new Mem_Dash_Model(R.mipmap.events,"Show Events"));
        ...
        iteamList.add(new Mem_Dash_Model(R.mipmap.vote,"Vote"));
